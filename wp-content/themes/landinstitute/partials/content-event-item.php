...
<div data-cudayname="<?php echo $cu_day_name; ?>" data-date="<?php echo $date;  ?>" data-id="<?php echo $pID; ?>" data-length="<?php echo $length;  ?>" data-current-length="<?php echo $current_length; ?>" style="background-color:<?php echo $color; ?>;" class="calendar-event <?php echo $item_class; ?> <?php echo $class; ?> <?php echo $last_day; ?> <?php echo $first_day; ?> <?php echo $has_class; ?>">
	<?php 
	if($current_length==1){ 
		echo '<div class="event-marquee">';
		if ($thumbnail_url) {
			echo '<img src="' . esc_url($thumbnail_url) . '" alt="" style="height:50px; vertical-align:middle; margin-right:10px;">';
		}
