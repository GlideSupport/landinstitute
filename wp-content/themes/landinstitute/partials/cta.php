			...
			<div class="row-grid">
				...
				<?php echo !empty($bst_var_pocta_bg_image) ? '<div class="pattern6">' . wp_get_attachment_image($bst_var_pocta_bg_image, 'thumb_1000', false, ['class' => 'desktop-img']) . '</div><div class="gl-s156"></div>' : ''; ?>
					<div class="right-col-content">
						<?php echo !empty($bst_var_pocta_button_one) ? '<div class="two-row-btn">' . BaseTheme::button($bst_var_pocta_button_one, 'site-btn btn-sunflower-yellow arrow-heart-symbol') . '</div>' : ''; ?>
