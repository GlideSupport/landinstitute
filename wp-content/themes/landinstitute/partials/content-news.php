...
$form_embed = $bst_fields['li_nwd_form_embed'] ?? $bst_var_form_embed;
            ...
            <div class="hero-alongside-block">
                ...
                <div class="col-content bg-lime-green">
                    ...
                    <div class="col-content-row d-flex">
                        ...
                        <?php endif; ?>
                        <?php if(!empty($li_nwd_publication)): ?>
                        <div class="column-content">
                ...
                <div class="col-left bg-lime-green">
                    <div class="hero-content">
                        ...
                        <?php echo !empty($li_nwd_authors) ? '<div class="gl-s6"></div>' : ''; ?>
                        <?php echo !empty($li_nwd_authors) ? '<div class="block-content body-18-16-regular">' . $li_nwd_authors . '</div>' : ''; ?>
                        <?php echo !empty($li_nwd_publication) ? '<div class="gl-s36"></div><div class="ui-eyebrow-16-15-bold eybrow-title">Publications</div>' : ''; ?>
                        <?php echo !empty($li_nwd_publication) ? '<div class="gl-s6"></div>' : ''; ?>
                        <?php if (!empty($link) && !empty($li_nwd_publication)) : ?>
...
<?php if ($li_no_bg_image_visible !== false): ?>
                                    ...
                                    <div class="image tag-show">
                                        ...
                                        <div class="tag-date">
                                            <div class="block-content eyebrow ui-eyebrow-16-15-regular">
                                                <?php echo esc_html( $li_nwd_date ); ?></div>
                                        </div>
                                        <?php endif; ?>
                                        <?php
