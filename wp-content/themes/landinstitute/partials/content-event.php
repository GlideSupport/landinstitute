...
$newsletter_form_visible = get_field('li_cpt_event_newsletter_form_visible',$bst_var_post_id) ?? '';
$li_cpt_title = $bst_fields['li_cpt_title'] ?? $bst_var_title;
$kicker = $bst_fields['li_cpt_kicker'] ?? $bst_var_kicker;

$select_form_type = $bst_fields['li_cpt_select_form_type'] ?? $bst_var_select_form_type;
$form_selector = $bst_fields['li_cpt_form_selector'] ?? $bst_var_form_selector;
$form_embed = $bst_fields['li_cpt_form_embed'] ?? $bst_var_form_embed;
