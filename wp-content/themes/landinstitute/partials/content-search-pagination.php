...
<div class="pagination-container append-search-result-pagination">
    ...
    <div class="desktop-pages">
        <div class="arrow-btn prev">
            <?php if ( $current_page > 1 ) : ?>
                <a rel="prev" class="site-btn" data-page="<?php echo esc_attr( $current_page - 1 ); ?>" href="<?php echo esc_url( $current_page === 2 ? $base_url : $base_url . 'page/' . ( $current_page - 1 ) . '/' ); ?>">
            ...
            for ( $i = 1; $i <= $total_pages; $i++ ) {
                if ( $i == 1 || $i == $total_pages || ( $i >= $current_page - $range && $i <= $current_page + $range ) ) {
                    ...
                    if ( $i == $current_page ) {
                        ...
                        echo '<a href="' . esc_url( $url ) . '" data-page="' . esc_attr( $i ) . '" class="page-btn"' . ( $rel ? ' rel="' . esc_attr( $rel ) . '"' : '' ) . '>' . esc_html( $i ) . '</a>';
                    }
        ...
        <div class="arrow-btn next">
            <?php if ( $current_page < $total_pages ) : ?>
                <a rel="next" class="site-btn" data-page="<?php echo esc_attr( $current_page + 1 ); ?>" href="<?php echo esc_url( $base_url . 'page/' . ( $current_page + 1 ) . '/' ); ?>">
    ...
    <div class="mobile-pagination">
        <?php if ( $current_page > 1 ) : ?>
            <a id="prevBtn" rel="prev" class="arrow-btn page-btn" data-page="<?php echo esc_attr( $current_page - 1 ); ?>" href="<?php echo esc_url( $current_page === 2 ? $base_url : $base_url . 'page/' . ( $current_page - 1 ) . '/' ); ?>">
                <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/src/images/right-circle-arrow.svg' ); ?>" alt="Previous" />
            </a>
        <?php else : ?>
             <a id="prevBtn" rel="prev" class="arrow-btn disabled" data-page="<?php echo esc_attr( $current_page - 1 ); ?>" href="<?php echo esc_url( $current_page === 2 ? $base_url : $base_url . 'page/' . ( $current_page - 1 ) . '/' ); ?>">
                <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/src/images/right-circle-arrow.svg' ); ?>" alt="Previous" />
        </a>
        <?php endif; ?>
        ...
        <?php if ( $current_page < $total_pages ) : ?>
            <a rel="next" id="nextBtn" class="arrow-btn page-btn" data-page="<?php echo esc_attr( $current_page + 1 ); ?>" href="<?php echo esc_url( $base_url . 'page/' . ( $current_page + 1 ) . '/' ); ?>">
                <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/src/images/right-circle-arrow.svg' ); ?>" alt="Next" />
            </a>
        <?php else : ?>
            <a rel="next" id="nextBtn" class="arrow-btn  disabled " data-page="<?php echo esc_attr( $current_page + 1 ); ?>" href="<?php echo esc_url( $base_url . 'page/' . ( $current_page + 1 ) . '/' ); ?>">
                <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/src/images/right-circle-arrow.svg' ); ?>" alt="Next" />
            </a>
        <?php endif; ?>
    </div>
