		...
		<div class="header-wrapper header-inner d-flex">
			...
			<?php if (!empty($bst_var_tbar_vsblty) && $base_theme_option_global_manual == 'global') {
				if (!empty($bst_var_hb_content)) { ?>
					<div class="right-top-head top-head-mobile">
						<div class="top-list-menu">
							<div class="top-bar mobile-top-bar global" id="top-bar-ajax" data-cookie-days="<?php echo esc_attr($cookie_days); ?>"
				...
				if (!empty($base_theme_option_content)) { ?>
					<div class="right-top-head top-head-mobile">
						<div class="top-list-menu">
							<div class="top-bar mobile-top-bar manual" id="top-bar-ajax" data-cookie-days="<?php echo esc_attr($cookie_days); ?>" <?php echo isset($_COOKIE['helloBarClosed']) ? 'style="display: none;"' : ''; ?>>
								<div class="top-bar-text">
									<?php
									if (!empty($base_theme_option_content)):
