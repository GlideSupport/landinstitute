...
$final_date = str_replace(',', ' -', date_formatting($cota_cpt_event_start_date, $cota_cpt_event_end_date));
...
<div class="tooltip-inner">
	<div class="tooltip-items">
		<span class="close-event-btn"><img
				src="<?php echo esc_url(get_template_directory_uri()) ?>/assets/src/images/close-icon.svg">
		</span>
		<div class="tooltip-items-row">
				...
				<div class="tooltip-tags">
					...
					<a href="<?php if ($cota_cpt_event_external_links == "true") {
						...
						<?php if ($cota_cpt_event_btn_des == 'normal') { ?>
							<span class="reset-bg"
								style="background-image: url(<?php echo esc_url(get_template_directory_uri()); ?>/assets/img/ticket-icon.svg);"></span>
						<?php } ?>
