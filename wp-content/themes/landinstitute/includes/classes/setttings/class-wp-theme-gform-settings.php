...
class WP_Theme_GForm_Settings {
	...
	public function __construct() {
		...
		// Filter to modify the tabindex for the second form (ID 1)
		add_filter('gform_tabindex_1', array(__CLASS__, 'change_tabindex'), 11, 2);
	}

	/**
	 * Change the tabindex value for a specific Gravity Form.
	 *
	 * This function modifies the tabindex for form fields, specifically for the form
	 * with ID 1. It is used in conjunction with the `gform_tabindex_1` filter.
	 *
	 * @param int $tabindex The current tabindex value set by Gravity Forms.
	 * @param array $form The form object, which contains all the data related to the form.
	 *
	 * @return int The new tabindex value to be used. In this case, it always returns 0.
	 */
	public static function change_tabindex($tabindex, $form)
	{
		// Return 0 to set the tabindex for this form to 0
		return 0;
	}
	/**
