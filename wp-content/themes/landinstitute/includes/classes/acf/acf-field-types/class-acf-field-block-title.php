...
class Acf_Field_Block_Title extends \acf_field
{
	...
	public function __construct()
	{
		 ...
		 */
		$this->label = __('Block Title', 'land_institute');
	...
	public function render_field_settings($field)
	{
		...
		acf_render_field_setting(
			$field,
			array(
				'label' => __('Instructions (Block Title)', 'land_institute'),
				'instructions' => __('Customize the Block Title input instructions', 'land_institute'),
				'type' => 'text',
		...
		acf_render_field_setting(
			$field,
			array(
				'label' => __('Instructions ( HTML Tag)', 'land_institute'),
				'instructions' => __('Customize the HTML tag input instructions', 'land_institute'),
				'type' => 'text',
