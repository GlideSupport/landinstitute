...
class Acf_Field_Spacers extends \acf_field {
	...
	public function render_field_settings( $field ) {
		...
		acf_render_field_setting(
			$field,
			array(
				'label'        => __( 'Instructions (Margin From Top)', 'land_institute' ),
				'instructions' => __( 'Customize the Margin From Top input instructions', 'land_institute' ),
				'type'         => 'text',
		...
		acf_render_field_setting(
			$field,
			array(
				'label'        => __( 'Instructions ( Margin From Bottom)', 'land_institute' ),
				'instructions' => __( 'Customize the Margin From Bottom input instructions', 'land_institute' ),
				'type'         => 'text',
