...
// Block variables.
$li_s_headline = $bst_block_fields['li_s_headline'] ?? null;
$li_s_headline_check = BaseTheme::headline_check($li_s_headline);
$li_s_choose_variation = $bst_block_fields['li_s_choose_variation'] ?? 'with-text';
$li_s_kicker = $bst_block_fields['li_s_kicker'] ?? null;
$li_s_image = $bst_block_fields['li_s_image'] ?? null;
$li_s_wysiwyg = $bst_block_fields['li_s_wysiwyg'] ?? null;
...
<?php 
	if($li_s_choose_variation == 'with-text'):
		include 'part/with-text.php';
	endif;
	if($li_s_choose_variation == 'grid'):
		include 'part/grid.php';
	endif;
	if($li_s_choose_variation == 'map'):
