...
$li_dl_choose_variation = $bst_block_fields['li_dl_choose_variation'] ?? 'variation-one';
$li_dl_wysiwyg = $bst_block_fields['li_dl_wysiwyg'] ?? null;
$li_dl_main_repeater = $bst_block_fields['li_dl_main_repeater'] ?? null;
$li_dl_main_repeater_two = $bst_block_fields['li_dl_main_repeater_two'] ?? null;
...
<?php 
	if($li_dl_choose_variation == 'variation-one'):
		include 'part/variation-one.php';
	endif;
	if($li_dl_choose_variation == 'variation-two'):
