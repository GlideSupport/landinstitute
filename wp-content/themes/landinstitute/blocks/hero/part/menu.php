		...
		<div class="hero-default <?php echo esc_attr($border_options); ?>">
			<div class="wrapper">
				<div class="hero-alongside-block">
						...
						<?php echo (!empty($li_hero_headline_check) || !empty($menu_label)) ? '<div class="gl-s36"></div>' : ''; ?>
							...
							<?php if (!empty($menu_value)) :
								...
								<div class="tab-dropdown">
									<button class="dropdown-toggle" id="category-view" aria-expanded="false" aria-haspopup="true" aria-controls="category-view">
									...
									wp_nav_menu(array(
										...
										'menu_id'        => 'category-view',
										'items_wrap'     => '<ul id="%1$s" class="%2$s" role="menu" aria-labelledby="category-view">%3$s</ul>',
									));
									?>
								</div>
							<?php endif; ?>
					...
					<div class="col-right">
					<?php echo !empty($bg_image) ? '<div class="bg-pattern pattern-top-align">' . wp_get_attachment_image($bg_image, 'thumb_1600') . '</div>' : ''; ?>
