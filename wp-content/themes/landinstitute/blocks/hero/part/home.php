							...
							<div class="announcement-left">
								<div class="announcement-image">
									...
									<?php
										...
										<video class="videos" playsinline="playsinline" muted="muted" preload="none" autoplay="autoplay" loop="loop"
											poster="<?php echo $video_thumb_url; ?>" data-video-init="">
											<source src="<?php echo esc_url(wp_get_attachment_url($video_file)); ?>" type="video/mp4">
										</video>
										<?php
										} elseif (!empty($video_thumb)) { ?>
										<video class="videos" playsinline="playsinline" muted="muted" preload="metadata" autoplay="autoplay"
											loop="loop" poster="<?php echo $video_thumb_url; ?>" data-video-init="">
										</video>
									<?php } ?>
