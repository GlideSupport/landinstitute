...
// Block variables.
$li_lp_wysiwyg = $bst_block_fields['li_lp_wysiwyg'] ?? null;

if (!empty($li_lp_wysiwyg)): ?>
	<?php echo !empty($li_lp_wysiwyg) ? '<div class="body-26-23-bold">' . html_entity_decode($li_lp_wysiwyg) . '</div>' : ''; ?>
<?php endif; ?>