 ...
 * Block Name: Timeline
 *
 * The template for displaying the custom gutenberg block named Timeline.
 *
...
// Block variables.
$li_t_choose_variation = $bst_block_fields['li_t_choose_variation'] ?? 'fancy';
$li_t_kicker = $bst_block_fields['li_t_kicker'] ?? null;
$li_t_repeater = $bst_block_fields['li_t_repeater'] ?? null; ?>
...
<div id="<?php echo esc_html($bst_block_html_id); ?>" class="<?php echo esc_html($bst_var_align_class . ' ' . $bst_var_class_name . ' ' . $bst_var_name); ?> block-<?php echo esc_html($bst_block_name); ?>" style="<?php echo esc_html($bst_block_styles); ?> ">
	<?php 
	if($li_t_choose_variation == 'fancy'):
		include 'part/fancy.php';
	endif;
	if($li_t_choose_variation == 'simple'):
