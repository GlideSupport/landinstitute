<?php if (!empty($li_t_repeater) || !empty($li_t_kicker)) : ?>
	<div class="timeline-block <?php echo esc_attr($border_options); ?>">
		<?php echo !empty($li_t_kicker) ? '<div class="ui-20-18-bold-uc kicker-title mb-0">' . esc_html($li_t_kicker) . '</div><div class="gl-s44"></div>' : ''; ?>
								...
								<div class="swiper-slide">
									<div class="border-card fancy-border-card">
										<div class="border-card-click">
											...
											<?php echo !empty($content) ? '<div class="body-18-16-regular block-content">' . html_entity_decode($content) . '</div>' : ''; ?>
