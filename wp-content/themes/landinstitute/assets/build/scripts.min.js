...
var map = {
	"./accordion.js": "./assets/src/js/partials/accordion.js",
	"./ajax.js": "./assets/src/js/partials/ajax.js",
	"./equal-height.js": "./assets/src/js/partials/equal-height.js",
	"./events.js": "./assets/src/js/partials/events.js",
	"./lity.min.js": "./assets/src/js/partials/lity.min.js",
	"./site-scripts.js": "./assets/src/js/partials/site-scripts.js",
	"./swiper-custom.js": "./assets/src/js/partials/swiper-custom.js"
};
...
/***/ "./assets/src/js/partials/accordion.js":
/*!*********************************************!*\
  !*** ./assets/src/js/partials/accordion.js ***!
  \*********************************************/
/***/ (() => {
...
/***/ "./assets/src/js/partials/ajax.js":
/*!****************************************!*\
  !*** ./assets/src/js/partials/ajax.js ***!
  \****************************************/
/***/ (() => {
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    menu.querySelectorAll("a[data-term]").forEach(link => {
      link.addEventListener("click", e => {
        ...
        if (taxonomy === "donor-type") {
          ...
          document.querySelector("button#donor-type").innerHTML = "Donor type: " + (term === "all" ? "All types" : term.replace(/-/g, " "));
        } else if (taxonomy === "donation-level") {
          currentDonationLevel = term;
          document.querySelector("button#donation-level").innerHTML = "Donation level: " + (term === "all" ? "All levels" : term.replace(/-/g, " "));
        }
        currentPage = 1;
        fetchDonors();
      });
  ...
  function attachPaginationEventListeners() {
    ...
    if (pageTrigger && paginationPopup) {
      ...
      document.addEventListener("click", function (e) {
        if (paginationPopup.classList.contains("active") && !paginationPopup.contains(e.target) && e.target !== pageTrigger) {
    ...
    fetch(localVars.ajax_url, {
      ...
      if (data.success) {
        ...
        if (oldPagination) {
          ...
          learn_pagination.insertAdjacentHTML("beforeend", `${data.data.pagination_html}`);
        }
  ...
  document.querySelectorAll(".search-list-filter .dropdown-menu").forEach(menu => {
    menu.querySelectorAll("a[data-post]").forEach(link => {
      link.addEventListener("click", e => {
        ...
        document.querySelector("#searchForm .search-type-field").value = searcheve;
        document.querySelector("#searchForm .learn-type-field").value = learntaxeve;
  ...
  document.querySelectorAll(".menu-search-type-list .dropdown-menu").forEach(menu => {
    menu.querySelectorAll("a[data-post]").forEach(link => {
      link.addEventListener("click", e => {
        e.preventDefault();
        const term = link.getAttribute("data-post");
        ...
        document.querySelector("#header-search-form .learn-type-field").value = taxonomy;
      });
    });
  });
  ...
  function featch_search_list(paged = 1, updateURL = true, searcheve = "all", learntaxeve = "") {
    currentPage = paged;
  ...
  document.querySelectorAll("#search-orderby-tabs .tab-link").forEach(tab => {
    tab.addEventListener("click", function (e) {
      ...
      // Run search again
      featch_search_list(1, true, document.querySelector("#searchForm .search-type-field").value, document.querySelector("#searchForm .learn-type-field").value);
    });
  });
  function initsearch_pagination() {
    document.querySelectorAll(".search-main .pagination-container .page-btn").forEach(btn => {
      btn.addEventListener("click", function (e) {
        ...
        const page = parseInt(this.getAttribute("data-page"));
        if (!isNaN(page) && page !== currentPage) {
          featch_search_list(page, true, document.querySelector("#searchForm .search-type-field").value, document.querySelector("#searchForm .learn-type-field").value);
        }
      });
    });
  ...
  if (searchForm) {
    searchForm.addEventListener("submit", function (e) {
      ...
      featch_search_list(1, true, document.querySelector("#searchForm .search-type-field").value, document.querySelector("#searchForm .learn-type-field").value); // call with page 1 on new search
    });
  }
  initsearch_pagination();
});
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  document.querySelectorAll("#search-type li").forEach(li => {
    ...
    const isActive = selectedLearnType && postTaxonomy === selectedLearnType || !selectedLearnType && !postTaxonomy && postType === selectedType;
...
/***/ "./assets/src/js/partials/equal-height.js":
/*!************************************************!*\
  !*** ./assets/src/js/partials/equal-height.js ***!
  \************************************************/
/***/ (() => {
...
/***/ "./assets/src/js/partials/events.js":
/*!******************************************!*\
  !*** ./assets/src/js/partials/events.js ***!
  \******************************************/
/***/ (() => {
...
if (loadMoreBtn) {
  loadMoreBtn.addEventListener('click', function (e) {
    ...
    fetch(localVars.ajax_url + '?action=load_more_events&page=' + page).then(res => res.json()).then(data => {
...
document.addEventListener('DOMContentLoaded', function () {
  document.querySelectorAll('.event-calendar-row').forEach(function (row) {
    ...
    const columnClasses = ['ct-first-row', 'ct-second-row', 'ct-third-row', 'ct-forth-row', 'ct-fifth-row', 'ct-first-col', 'ct-second-col', 'ct-third-col', 'ct-forth-col', 'ct-fifth-col', 'ct-sixth-col', 'ct-seventh-col'];
    ...
    row.querySelectorAll('.calendar-column').forEach(function (col, ii) {
      let rowClass = '';
      if (ii < 7) rowClass = 'ct-first-row';else if (ii < 14) rowClass = 'ct-second-row';else if (ii < 21) rowClass = 'ct-third-row';else if (ii < 28) rowClass = 'ct-forth-row';else rowClass = 'ct-fifth-row';
      const columnMap = {
...
/***/ "./assets/src/js/partials/lity.min.js":
/*!********************************************!*\
  !*** ./assets/src/js/partials/lity.min.js ***!
  \********************************************/
...
if (menuBtn && navOverlay) {
  menuBtn.addEventListener("click", () => {
    ...
    document.querySelectorAll(".header-nav ul.sub-menu").forEach(subMenu => {
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function updateStickyPosition() {
    ...
    stickyWrappers.forEach(wrapper => {
      ...
      const rightSideBottom = rightSide.offsetTop + rightSide.offsetHeight;
      ...
      // Lock image at the bottom of container
        ...
        const offsetBottom = rightSideBottom - containerTop - imageHeight;
...
document.addEventListener("click", event => {
  if (event.target.matches(".header-nav .menu-item span")) {
    ...
    if (link) {
      ...
      link.parentElement.querySelectorAll(".active").forEach(activeSibling => {
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const getMaxTarget = () => {
    return Math.max(...Array.from(counters).map(counter => +counter.closest(".counter-number").getAttribute("data-target")));
  };
  const maxTarget = getMaxTarget(); // Find the highest target value

  const countUp = counter => {
    const target = +counter.closest(".counter-number").getAttribute("data-target");
...
const HeadermenuAppend = [{
  dropdownId: "#mega-dropdown-our-work",
  menuClass: "our-work"
}, {
  dropdownId: "#mega-dropdown-learn",
  menuClass: "learn"
}];
HeadermenuAppend.forEach(({
  dropdownId,
  menuClass
}) => {
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (searchBtn && searchPopup) {
    ...
    document.addEventListener("click", function (e) {
      const isInsideSearch = searchPopup.contains(e.target) || searchBtn.contains(e.target) || searchContainer?.contains(e.target);
      if (!isInsideSearch) {
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function enableDragging() {
    ...
    // Touch events
    galleryBlock.addEventListener("touchstart", startDrag, {
      passive: false
    });
    ...
    galleryBlock.addEventListener("touchstart", e => {
  ...
  function updateTransform() {
    ...
    tween = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(galleryGrid, {
      x: targetX,
      y: targetY,
      duration: 0.1,
      ease: "power1.out"
...
/***/ "./assets/src/js/partials/swiper-custom.js":
/*!*************************************************!*\
  !*** ./assets/src/js/partials/swiper-custom.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document.querySelectorAll(".cta-slider-box").forEach((wrapper, index) => {
    ...
    // Initialize Swiper
    const swiper = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](`.${uniqueClass}`, {
      loop: false,
      effect: "fade",
      autoHeight: true,
      fadeEffect: {
  ...
  document.querySelectorAll(".impact-map-block").forEach(blockWrapper => {
    ...
    function runCounters(fromSlide, toSlide, isInitial = false) {
      ...
      toCounters.forEach((counter, i) => {
        ...
        if (isInitial) {
          ...
          start = lastValues[i] !== undefined ? lastValues[i] : parseInt(counter.dataset.start, 10);
        }
    ...
    // Swiper main
    const galleryTop = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](mapSlides, {
      spaceBetween: 0,
      speed: 10,
    ...
    // Swiper thumbs
    if (mapYears) {
      const galleryThumbs = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](mapYears, {
        spaceBetween: 0,
        slidesPerView: "auto",
  ...
  sliderWrappers.forEach((wrapper, index) => {
    ...
    new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](`.${wrapperClass}-container`, {
      loop: false,
      slidesPerView: 1,
      spaceBetween: 20,
      navigation: {
  ...
  if (logolistslider) {
    new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](logolistslider, {
      loop: false,
      navigation: false,
      slidesPerView: 1.26,
      spaceBetween: 32,
  ...
  if (swiperEl) {
    ...
    const nextBtn = container.querySelector(".swiper-button-next");
    const prevBtn = container.querySelector(".swiper-button-prev");
    const swiper = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](swiperEl, {
      slidesPerView: 1,
      spaceBetween: 0,
      breakpoints: {
        480: {
