...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // Swiper main
  const galleryTop = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](".map-slides", {
    spaceBetween: 0,
    speed: 1000,
    navigation: {
  ...
  // Swiper thumbs
  const galleryThumbs = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](".map-years", {
    spaceBetween: 0,
    slidesPerView: "auto",
